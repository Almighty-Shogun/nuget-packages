...
fields:
    ...
    - name: TwoFactorPolicy
      description: The nested `CredentialAuth:TwoFactor` section, describing the codes this package generates and accepts.
      fields:
          - name: Issuer
...
public sealed class PasswordResetLinkBuilder(
    IOptions<CredentialAuthSettings> options
)
{
