...
::: tip
Place it before any middleware that writes a localized body, including [`UseHttpErrorResponses`](./use-http-error-responses), so the header is set on error responses too.
:::
