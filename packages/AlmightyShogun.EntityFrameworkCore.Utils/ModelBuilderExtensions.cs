...
/// <summary>
/// Provides reusable Entity Framework Core model configuration helpers for common relationship, include, and index mappings.
/// </summary>
///
...
public static class ModelBuilderExtensions
{
    ...
    extension(ModelBuilder modelBuilder)
    {
        ...
        /// <param name="principalKey">Optional principal key property. When omitted, Entity Framework Core uses the principal primary key.</param>
        /// <param name="isRequired">Whether the relationship is required. The default is <c>true</c>.</param>
        /// <param name="deleteBehavior">Delete behavior for the relationship. The default is <see cref="DeleteBehavior.ClientSetNull"/>.</param>
        ...
        /// <param name="foreignKey">Foreign key property on the dependent entity.</param>
        /// <param name="principalKey">Optional principal key property. When omitted, Entity Framework Core uses the principal primary key.</param>
        /// <param name="isRequired">Whether the relationship is required. The default is <c>false</c>.</param>
        /// <param name="deleteBehavior">Delete behavior for the relationship. The default is <see cref="DeleteBehavior.ClientSetNull"/>.</param>
        /// <param name="inverseNavigation">Optional reference navigation on the dependent entity back to the principal entity. When omitted, the relationship has no inverse navigation.</param>
        ///
        /// <returns>The <see cref="ModelBuilder"/> instance.</returns>
        ...
        /// <param name="foreignKey">Foreign key property on the dependent entity.</param>
        /// <param name="principalKey">Optional principal key property. When omitted, Entity Framework Core uses the principal primary key.</param>
        /// <param name="isRequired">Specifies whether the relationship is required. The default is <c>false</c>.</param>
        /// <param name="deleteBehavior">Delete behavior for the relationship. The default is <see cref="DeleteBehavior.ClientSetNull"/>.</param>
