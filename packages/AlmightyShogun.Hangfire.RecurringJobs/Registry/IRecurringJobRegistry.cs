...
{
    /// <summary>
    /// The jobs the scan kept, which are the ones the scheduler hands to Hangfire, rather than what a fresh scan would
    /// find. Nothing here records whether the handover actually happened. A job left disabled is absent even though it was
    /// discovered and validated, so this reports what runs here rather than what the assemblies declare.
    /// </summary>
    ///
    /// <author>Almighty-Shogun</author>
    /// <since>4.0.0</since>
