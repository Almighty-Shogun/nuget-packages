...
/// <summary>
/// Answers this package's exceptions with the standardized error response, using CredentialAuthExceptionMapper to decide the
...
internal sealed class CredentialAuthExceptionHandler(
    CredentialAuthExceptionMapper exceptionMapper,
    IMessageResolver messageResolver,
    IHttpErrorResponseWriter responseWriter,
    ILogger<CredentialAuthExceptionHandler> logger
) : IExceptionHandler
{
    /// <inheritdoc />
