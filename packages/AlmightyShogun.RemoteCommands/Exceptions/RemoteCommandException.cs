...
/// unreachable server, a disconnection, and a frame that is not an envelope without having to name each. It does not
/// cover everything a send can throw: a framing error surfaces as <see cref="InvalidDataException"/>, an unreadable
/// envelope as <see cref="JsonException"/>, and a canceled wait as <see cref="OperationCanceledException"/>, none of
/// which derive from this type.
/// </summary>
///
/// <param name="message">The explanation, safe to show to whoever ran the command.</param>
/// <param name="innerException">
/// The transport failure underneath, or <c>null</c> when the subclass has none to carry, as when the server answered or
/// the peer closed with no error to observe.
/// </param>
///
/// <remarks>
