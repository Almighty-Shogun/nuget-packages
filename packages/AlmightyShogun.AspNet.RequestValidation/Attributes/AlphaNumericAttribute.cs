...
public sealed class AlphaNumericAttribute : ValidationRuleAttribute
{
    /// <inheritdoc />
    internal override IPropertyValidationRule<TRequest, TProperty> CreateRule<TRequest, TProperty>(PropertyInfo property)
        => new StringCharacterValidationRule<TRequest, TProperty>(StringCharacterMode.AlphaNumeric);
}
