...
{
    /// <summary>
    /// The enum membership is checked against, unwrapped from <see cref="Nullable{T}"/> so a nullable enum property
    /// is checked against the same set its non-nullable spelling would be.
    /// </summary>
    ///
    /// <author>Almighty-Shogun</author>
    /// <since>4.0.0</since>
