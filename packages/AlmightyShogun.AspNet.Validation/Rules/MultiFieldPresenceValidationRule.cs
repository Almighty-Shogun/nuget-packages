...
/// <summary>
/// Validates multi-field presence constraints for a request property.
/// </summary>
///
/// <author>Almighty-Shogun</author>
/// <since>Unreleased</since>
internal sealed class MultiFieldPresenceValidationRule<TRequest, TProperty>(MultiFieldPresenceTargetMode targetMode, MultiFieldPresenceTriggerMode triggerMode, params Expression<Func<TRequest, object?>>[] compareExpressions) : IPropertyValidationRule<TRequest, TProperty> where TRequest : class
{
