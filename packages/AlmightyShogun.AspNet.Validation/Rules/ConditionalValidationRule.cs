...
/// <summary>
/// Validates conditional constraints for a request property.
/// </summary>
///
/// <author>Almighty-Shogun</author>
/// <since>Unreleased</since>
internal sealed class ConditionalValidationRule<TRequest, TProperty, TCompare>(ConditionalTargetMode targetMode, ConditionMode conditionMode, Expression<Func<TRequest, TCompare>> compareExpression, IReadOnlyList<TCompare?> values) : IPropertyValidationRule<TRequest, TProperty> where TRequest : class
{
